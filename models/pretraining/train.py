...
from models.pretraining.model import PriorPretrainingModel
...
def add_special_tokens_(model, tokenizer):
    ...
    #model.gpt2_model.resize_token_embeddings(new_num_tokens=orig_num_tokens + num_added_tokens) TODO

'''
python3 -m models.pretraining.train --dataset_path=data/personachat/weak_label_comet_personachat/personachat_self_original_comet_scores_alignlabels.expanded_persona_preprocessed.json --model_checkpoint=gpt2 --gradient_accumulation_steps=4 --max_history=2 --n_epochs=3 --num_candidates=1 --personality_permutations=1 --train_batch_size=1 --valid_batch_size=1 --exp_name pretrain_debug --no_comet_persona --do_train --test_run_num 1 --log_dir logdir/
'''
...
def train():
    ...
    model = PriorPretrainingModel(args) #, generator_class=model_class)
    model.to(args.device)
    ...
    def update(engine, batch):
        ...
        loss = mc_loss #(lm_loss * args.lm_coef + mc_loss * args.mc_coef) / args.gradient_accumulation_steps
