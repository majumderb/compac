    ...
    for u_i, utterance in enumerate(dialog['utterances']):
        ...
        for itr in range(2):
            ...
            if itr == 0:
                ...
                print('Correct Candidate for OG: {}'.format(utterance['candidates'][candidate_scores[0][0]]))
            elif itr == 1:
                itr1 = 1 if candidate_scores[0][0] == gt_index else 0
                print('Correct Candidate for Comet: {}'.format(utterance['candidates'][candidate_scores[0][0]]))
